package com.softding.generator.controller;
...
import com.softding.generator.service.IGenTableColumnService;
...
public class GenController extends BaseController
{
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"softding-generator.zip\"");
